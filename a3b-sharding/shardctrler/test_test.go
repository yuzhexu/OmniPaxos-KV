...
func TestBasic4A(t *testing.T) {
	...
	results := map[string]bool{
		"Basic leave/join":              false,
		"Move":                          false,
		"Concurrent leave/join":         false,
		"Minimal transfers after joins": false,
		"Minimal transfers after leave": false,
	}
	...
	fmt.Printf("  ... Passed\n")
	results["Concurrent leave/join"] = true
	...
	fmt.Printf("  ... Passed\n")
	results["Minimal transfers after joins"] = true
